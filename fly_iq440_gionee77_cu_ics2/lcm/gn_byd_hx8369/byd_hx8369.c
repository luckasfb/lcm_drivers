...
//Qux
#define LCM_V_LEVEL   LCM_V_BYD   //voltage level 
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.pll_div1=26; // fref=26MHz, fvco=fref*(div1+1) (div1=0~63, fvco=500MHZ~1GHz) //38 Gionee :wangc modified for crash screen at 2012-9-17
...
// ---------------------------------------------------------------------------
LCM_DRIVER gn_byd_hx8369_lcm_drv = 
{
    .name           = "gn_byd_hx8369",
