...
//begin wpf add for ALPS00297171(For_SIMCOM75CU_BU2_NAND_GB2_ALPS.GB2.MP.V1.10_P31)
#ifndef TRUE
    #define TRUE 1
#endif
#ifndef FALSE
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		// enable tearing-free
		params->dbi.te_mode 				= LCM_DBI_TE_MODE_DISABLED; //LCM_DBI_TE_MODE_VSYNC_ONLY; //wpf edit for ALPS00297171(For_SIMCOM75CU_BU2_NAND_GB2_ALPS.GB2.MP.V1.10_P31)
