...
static void init_lcm_registers(void)
{
	...
	send_data_cmd(0x00); 
	send_data_cmd(0x34); 
	send_data_cmd(0x0A); //03
	send_data_cmd(0x00); 
	send_data_cmd(0x11);  //VSP voltage setting[4:0]   0F=>10
	send_data_cmd(0x12);   //VSN voltage setting=-VSP[4:0]  0F=>10
	send_data_cmd(0x21); // 32
	send_data_cmd(0x29); // 2F
	send_data_cmd(0x3F); //3f
	send_data_cmd(0x3F); //3f
	send_data_cmd(0x01); //01
	send_data_cmd(0x0A); // 3a 
	send_data_cmd(0x01); 
	send_data_cmd(0xE6); 
	send_data_cmd(0xE6); 
	send_data_cmd(0xE6); 
	...
	send_data_cmd(0x00);   
	send_data_cmd(0x23); //res[2:0] rn dfr dm[1:0]   2B
	...
	send_data_cmd(0x02); //穃u017d转穃u0153蔦u0153   02-dot inversion  00 OK 
	send_data_cmd(0x18); //  soure on
	send_data_cmd(0x80); //   soure off
	send_data_cmd(0x13); //eq on  
	send_data_cmd(0x05);  //eqs 


	send_ctrl_cmd(0xB6);  // SET VCOM 
	send_data_cmd(0x4A);//3//A   
	send_data_cmd(0x4A); //3//A  
	...
	send_data_cmd(0xE6); //CGOUT8_L CGOUT7_L   //26 
	send_data_cmd(0x51); //CGOUT6_R CGOUT5_R   //51 
	send_data_cmd(0xF7); //CGOUT8_R CGOUT7_R   //37 
	...
	send_data_cmd(0x0A);  //G1_VRP3[5:0]
	send_data_cmd(0x09);  //G1_VRP4[5:0]
	send_data_cmd(0x18);  //G1_VRP5[5:0]
	send_data_cmd(0x1D);  //G1_PRP0[6:0]    12
	send_data_cmd(0x2A);  //G1_PRP1[6:0] 2E  
	send_data_cmd(0x08); //G1_CGMP0[1:0]    G1_PKP0[4:0]
	send_data_cmd(0x11); //G1_CGMP1[1:0]    G1_PKP1[4:0]
	send_data_cmd(0x0D); //G1_CGMP2[1:0]    G1_PKP2[4:0]
	send_data_cmd(0x13); //G1_CGMP3[1:0]    G1_PKP3[4:0]
	send_data_cmd(0x15); //G1_CGMP4,G1_CGMP5    G1_PKP4[4:0]
	send_data_cmd(0x14);  //G1_PKP5[4:0]
	send_data_cmd(0x15);  //G1_PKP6[4:0]
	send_data_cmd(0x0F);  //G1_PKP7[4:0]    8
	send_data_cmd(0x14);  //G1_PKP8[4:0]
	//*******************************************
	send_data_cmd(0x00);  //G1_VRP0[5:0]
	send_data_cmd(0x02);  //G1_VRP1[5:0]    
	send_data_cmd(0x0B);  //G1_VRP2[5:0]    
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dpi.vsync_pulse_width = 3;  //amy0529 2
...
#ifdef BUILD_UBOOT
#else
  // printk("###############  t040kwv048at_hx8369_lcm_drv lcm_suspend\r\n");
#endif
    send_ctrl_cmd(0x10);
    MDELAY(100);
...
#ifdef BUILD_UBOOT
#else
//printk("###############  t040kwv048at_hx8369_lcm_drv resume\r\n");
#endif 
}
...
// ---------------------------------------------------------------------------
LCM_DRIVER ut40022a0_hx8369_lcm_drv = 
{
	.name		= "ut4002a0_hx8369",
