...
#define LCM_NAME		"[RIXIN402IPS_NT35510]"
...
{ 	
	...
	send_ctrl_cmd(0xBE01); send_data_cmd(0xA3);
	...
	//Timing control 8phase dual side/4H/4Delayms/RST_EN
...
//	send_ctrl_cmd(0x4401); send_data_cmd(0x90);//ADD
	...
	send_ctrl_cmd(0x3600); send_data_cmd(0xC0);	// 0xC0
...
// ---------------------------------------------------------------------------
LCM_DRIVER rixin402ips_nt35510_lcm_drv = 
{
    .name			= "rixin402ips_nt35510",
