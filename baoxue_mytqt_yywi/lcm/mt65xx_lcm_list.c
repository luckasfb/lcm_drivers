...
extern LCM_DRIVER hc397_hx8352cn_lcm_drv;
extern LCM_DRIVER gt397_otm8009a_lcm_drv;
extern LCM_DRIVER xxd397_nt35512_lcm_drv;
...
#if defined(HC397_HX8352CN)
	&hc397_hx8352cn_lcm_drv,
#endif

#if defined(GT397_OTM8009A)
	&gt397_otm8009a_lcm_drv,
#endif

#if defined(XXD397_NT35512)
	&xxd397_nt35512_lcm_drv,
#endif

#if defined(FRD402_NT35510)
	&frd402_nt35510_lcm_drv,
#endif
