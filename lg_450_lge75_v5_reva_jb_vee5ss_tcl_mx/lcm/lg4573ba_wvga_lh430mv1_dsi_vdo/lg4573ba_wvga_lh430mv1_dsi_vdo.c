...
static void lcm_init(void)
{
...
#else
	hwPowerOn(MT65XX_POWER_LDO_VCAMA, VOL_2800, "2V8_LCD_VCI_MTK_S" );
	...
	*/
	...
	data_array[2] = 0x00490518;
	dsi_set_cmdq(&data_array, 3, 1);
	
	data_array[0] = 0x69C51500;
	dsi_set_cmdq(&data_array, 1, 1);

	data_array[0] = 0x00043902;
	data_array[1] = 0x036341C6;
	dsi_set_cmdq(&data_array, 2, 1);

	data_array[0] = 0x000A3902;
	data_array[1] = 0x773600D0;
	data_array[2] = 0x21000001;
	data_array[3] = 0x00000201;
	dsi_set_cmdq(&data_array, 4, 1);
					
	data_array[0] = 0x000A3902;
	data_array[1] = 0x773600D1;
	data_array[2] = 0x21000001;
	data_array[3] = 0x00000201;
	dsi_set_cmdq(&data_array, 4, 1);
					
	data_array[0] = 0x000A3902;
	data_array[1] = 0x773600D2;
	data_array[2] = 0x21000001;
	data_array[3] = 0x00000201;
	dsi_set_cmdq(&data_array, 4, 1);
					
	data_array[0] = 0x000A3902;
	data_array[1] = 0x773600D3;
	data_array[2] = 0x21000001;
	data_array[3] = 0x00000201;
	dsi_set_cmdq(&data_array, 4, 1);
					
	data_array[0] = 0x000A3902;
	data_array[1] = 0x773600D4;
	data_array[2] = 0x21000001;
	data_array[3] = 0x00000201;
	dsi_set_cmdq(&data_array, 4, 1);
					
	data_array[0] = 0x000A3902;
	data_array[1] = 0x773600D5;
	data_array[2] = 0x21000001;
	data_array[3] = 0x00000201;
	dsi_set_cmdq(&data_array, 4, 1);
...
LCM_DRIVER lg4573ba_wvga_lh430mv1_drv = 
{
    .name			= "lg4573ba_wvga_lh430mv1_dsi_vdo",
