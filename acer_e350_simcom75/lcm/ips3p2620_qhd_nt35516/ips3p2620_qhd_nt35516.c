...
static void init_lcm_registers(void)
{
...
#if 0
	xx
    LCD_PRINT("punk,init_lcm_registers  -1 truly code\n");
    ...
    send_ctrl_cmd(0xBE00); send_data_cmd(0x87);//punk 0x92->0x87
...
#else
	LCD_PRINT("punk,init_lcm_registers  -2.1 truly code\n");
	send_ctrl_cmd(0xFF00); send_data_cmd(0xAA);
	send_ctrl_cmd(0xFF01); send_data_cmd(0x55);
	send_ctrl_cmd(0xFF02); send_data_cmd(0x25);
	send_ctrl_cmd(0xFF03); send_data_cmd(0x01);
	...
	send_ctrl_cmd(0xF207); send_data_cmd(0x00);
	send_ctrl_cmd(0xF208); send_data_cmd(0x00);
	send_ctrl_cmd(0xF20A); send_data_cmd(0x00);// 原来是0xF210
	send_ctrl_cmd(0xF20B); send_data_cmd(0x00);// 原来是0xF211
	send_ctrl_cmd(0xF20C); send_data_cmd(0x00);// 原来是0xF212
	send_ctrl_cmd(0xF20D); send_data_cmd(0x00);// 原来是0xF213
	send_ctrl_cmd(0xF20E); send_data_cmd(0x00);// 原来是0xF214
	send_ctrl_cmd(0xF20F); send_data_cmd(0x00);// 原来是0xF215
	send_ctrl_cmd(0xF210); send_data_cmd(0x00);// 原来是0xF216
	send_ctrl_cmd(0xF211); send_data_cmd(0x0B);// 原来是0xF217
	send_ctrl_cmd(0xF212); send_data_cmd(0x00);// 原来是0xF218
	send_ctrl_cmd(0xF213); send_data_cmd(0x00);// 原来是0xF219
	send_ctrl_cmd(0xF214); send_data_cmd(0x00);// 原来是0xF220
	send_ctrl_cmd(0xF215); send_data_cmd(0x00);// 原来是0xF221
	send_ctrl_cmd(0xF216); send_data_cmd(0x00);// 原来是0xF222
	send_ctrl_cmd(0xF217); send_data_cmd(0x00);// 原来是0xF223
	send_ctrl_cmd(0xF218); send_data_cmd(0x00);// 原来是0xF224
	send_ctrl_cmd(0xF219); send_data_cmd(0x00);// 原来是0xF225
	send_ctrl_cmd(0xF21A); send_data_cmd(0x00);// 原来是0xF226
	send_ctrl_cmd(0xF21B); send_data_cmd(0x00);// 原来是0xF227
	send_ctrl_cmd(0xF21C); send_data_cmd(0x40);// 原来是0xF228
	send_ctrl_cmd(0xF21D); send_data_cmd(0x01);// 原来是0xF229
	send_ctrl_cmd(0xF21E); send_data_cmd(0x51);// 原来是0xF230
	send_ctrl_cmd(0xF21F); send_data_cmd(0x00);// 原来是0xF231
	send_ctrl_cmd(0xF220); send_data_cmd(0x01);// 原来是0xF232
	send_ctrl_cmd(0xF221); send_data_cmd(0x00);// 原来是0xF233
	send_ctrl_cmd(0xF222); send_data_cmd(0x01);// 原来是0xF234
	...
	send_ctrl_cmd(0xB000); send_data_cmd(0x03);//CMRC  VSDL  HSDL  DEDL  PCKP  DEP  HSP  VSP 
	...
	send_ctrl_cmd(0xBC00); send_data_cmd(0x00);//NLA2  NLA1  NLA0
	send_ctrl_cmd(0xBC01); send_data_cmd(0x00);//NLB2  NLB1  NLB0
	send_ctrl_cmd(0xBC02); send_data_cmd(0x00);//NLC2  NLC1  NLC0
	...
	send_ctrl_cmd(0xB400); send_data_cmd(0x0A);
	send_ctrl_cmd(0xB401); send_data_cmd(0x0A);
	send_ctrl_cmd(0xB402); send_data_cmd(0x0A);
	...
	send_ctrl_cmd(0xB800); send_data_cmd(0x20);//Set VCL boosting times/frequency
	send_ctrl_cmd(0xB801); send_data_cmd(0x20);
	send_ctrl_cmd(0xB802); send_data_cmd(0x20);

	send_ctrl_cmd(0xB900); send_data_cmd(0x26);//Set VGH boosting times/frequency
	send_ctrl_cmd(0xB901); send_data_cmd(0x26);
	send_ctrl_cmd(0xB902); send_data_cmd(0x26);

	send_ctrl_cmd(0xBA00); send_data_cmd(0x24);//Set VGLX boosting times/frequency
	send_ctrl_cmd(0xBA01); send_data_cmd(0x24);
	send_ctrl_cmd(0xBA02); send_data_cmd(0x24);

	send_ctrl_cmd(0xBC00); send_data_cmd(0x00);//Set VGMP/VGSP voltages 
	send_ctrl_cmd(0xBC01); send_data_cmd(0xC8);
	send_ctrl_cmd(0xBC02); send_data_cmd(0x00);

	send_ctrl_cmd(0xBD00); send_data_cmd(0x00);//Set VGMN/VGSN voltages
	send_ctrl_cmd(0xBD01); send_data_cmd(0xC8);
	send_ctrl_cmd(0xBD02); send_data_cmd(0x00);

	send_ctrl_cmd(0xBE00); send_data_cmd(0x71);//Setting DC VCOM offset 

	send_ctrl_cmd(0xC000); send_data_cmd(0x04);
	send_ctrl_cmd(0xC001); send_data_cmd(0x00);

	send_ctrl_cmd(0xCA00); send_data_cmd(0x00);//Gate signal voltage control 
	...
	send_ctrl_cmd(0xD108); send_data_cmd(0x01);
	send_ctrl_cmd(0xD109); send_data_cmd(0x21);
	send_ctrl_cmd(0xD10A); send_data_cmd(0x01);
	send_ctrl_cmd(0xD10B); send_data_cmd(0x44);
	send_ctrl_cmd(0xD10C); send_data_cmd(0x01);
	send_ctrl_cmd(0xD10D); send_data_cmd(0x62);
	send_ctrl_cmd(0xD10E); send_data_cmd(0x01);
	send_ctrl_cmd(0xD10F); send_data_cmd(0x8D);
	...
	send_ctrl_cmd(0xD20B); send_data_cmd(0x84);
	send_ctrl_cmd(0xD20C); send_data_cmd(0x02);
	send_ctrl_cmd(0xD20D); send_data_cmd(0xB8);
	send_ctrl_cmd(0xD20E); send_data_cmd(0x02);
	send_ctrl_cmd(0xD20F); send_data_cmd(0xF0);
	...
	send_ctrl_cmd(0xD30B); send_data_cmd(0xB0);
	send_ctrl_cmd(0xD30C); send_data_cmd(0x03);
	send_ctrl_cmd(0xD30D); send_data_cmd(0xC0);
	send_ctrl_cmd(0xD30E); send_data_cmd(0x03);
	send_ctrl_cmd(0xD30F); send_data_cmd(0xDF);
	...
	send_ctrl_cmd(0xD508); send_data_cmd(0x01);
	send_ctrl_cmd(0xD509); send_data_cmd(0x21);
	send_ctrl_cmd(0xD50A); send_data_cmd(0x01);
	send_ctrl_cmd(0xD50B); send_data_cmd(0x44);
	send_ctrl_cmd(0xD50C); send_data_cmd(0x01);
	send_ctrl_cmd(0xD50D); send_data_cmd(0x62);
	send_ctrl_cmd(0xD50E); send_data_cmd(0x01);
	send_ctrl_cmd(0xD50F); send_data_cmd(0x8D);
	...
	send_ctrl_cmd(0xD60B); send_data_cmd(0x84);
	send_ctrl_cmd(0xD60C); send_data_cmd(0x02);
	send_ctrl_cmd(0xD60D); send_data_cmd(0xB8);
	send_ctrl_cmd(0xD60E); send_data_cmd(0x02);
	send_ctrl_cmd(0xD60F); send_data_cmd(0xF0);
	...
	send_ctrl_cmd(0xD70B); send_data_cmd(0xB0);
	send_ctrl_cmd(0xD70C); send_data_cmd(0x03);
	send_ctrl_cmd(0xD70D); send_data_cmd(0xC0);
	send_ctrl_cmd(0xD70E); send_data_cmd(0x03);
	send_ctrl_cmd(0xD70F); send_data_cmd(0xDF);
	...
	send_ctrl_cmd(0xD908); send_data_cmd(0x01);
	send_ctrl_cmd(0xD909); send_data_cmd(0x21);
	send_ctrl_cmd(0xD90A); send_data_cmd(0x01);
	send_ctrl_cmd(0xD90B); send_data_cmd(0x44);
	send_ctrl_cmd(0xD90C); send_data_cmd(0x01);
	send_ctrl_cmd(0xD90D); send_data_cmd(0x62);
	send_ctrl_cmd(0xD90E); send_data_cmd(0x01);
	send_ctrl_cmd(0xD90F); send_data_cmd(0x8D);
	...
	send_ctrl_cmd(0xDD0B); send_data_cmd(0x84);
	send_ctrl_cmd(0xDD0C); send_data_cmd(0x02);
	send_ctrl_cmd(0xDD0D); send_data_cmd(0xB8);
	send_ctrl_cmd(0xDD0E); send_data_cmd(0x02);
	send_ctrl_cmd(0xDD0F); send_data_cmd(0xF0);
	...
	send_ctrl_cmd(0xDE0B); send_data_cmd(0xB0);
	send_ctrl_cmd(0xDE0C); send_data_cmd(0x03);
	send_ctrl_cmd(0xDE0D); send_data_cmd(0xC0);
	send_ctrl_cmd(0xDE0E); send_data_cmd(0x03);
	send_ctrl_cmd(0xDE0F); send_data_cmd(0xDF);
	...
	send_ctrl_cmd(0xE008); send_data_cmd(0x01);
	send_ctrl_cmd(0xE009); send_data_cmd(0x21);
	send_ctrl_cmd(0xE00A); send_data_cmd(0x01);
	send_ctrl_cmd(0xE00B); send_data_cmd(0x44);
	send_ctrl_cmd(0xE00C); send_data_cmd(0x01);
	send_ctrl_cmd(0xE00D); send_data_cmd(0x62);
	send_ctrl_cmd(0xE00E); send_data_cmd(0x01);
	send_ctrl_cmd(0xE00F); send_data_cmd(0x8D);
	...
	send_ctrl_cmd(0xE10B); send_data_cmd(0x84);
	send_ctrl_cmd(0xE10C); send_data_cmd(0x02);
	send_ctrl_cmd(0xE10D); send_data_cmd(0xB8);
	send_ctrl_cmd(0xE10E); send_data_cmd(0x02);
	send_ctrl_cmd(0xE10F); send_data_cmd(0xF0);
	...
	send_ctrl_cmd(0xE20B); send_data_cmd(0xB0);
	send_ctrl_cmd(0xE20C); send_data_cmd(0x03);
	send_ctrl_cmd(0xE20D); send_data_cmd(0xC0);
	send_ctrl_cmd(0xE20E); send_data_cmd(0x03);
	send_ctrl_cmd(0xE20F); send_data_cmd(0xDF);
	...
	send_ctrl_cmd(0xE408); send_data_cmd(0x01);
	send_ctrl_cmd(0xE409); send_data_cmd(0x21);
	send_ctrl_cmd(0xE40A); send_data_cmd(0x01);
	send_ctrl_cmd(0xE40B); send_data_cmd(0x44);
	send_ctrl_cmd(0xE40C); send_data_cmd(0x01);
	send_ctrl_cmd(0xE40D); send_data_cmd(0x62);
	send_ctrl_cmd(0xE40E); send_data_cmd(0x01);
	send_ctrl_cmd(0xE40F); send_data_cmd(0x8D);
	...
	send_ctrl_cmd(0xE50B); send_data_cmd(0x84);
	send_ctrl_cmd(0xE50C); send_data_cmd(0x02);
	send_ctrl_cmd(0xE50D); send_data_cmd(0xB8);
	send_ctrl_cmd(0xE50E); send_data_cmd(0x02);
	send_ctrl_cmd(0xE50F); send_data_cmd(0xF0);
	...
	send_ctrl_cmd(0xE60B); send_data_cmd(0xB0);
	send_ctrl_cmd(0xE60C); send_data_cmd(0x03);
	send_ctrl_cmd(0xE60D); send_data_cmd(0xC0);
	send_ctrl_cmd(0xE60E); send_data_cmd(0x03);
	send_ctrl_cmd(0xE60F); send_data_cmd(0xDF);
	...
	send_ctrl_cmd(0xE808); send_data_cmd(0x01);
	send_ctrl_cmd(0xE809); send_data_cmd(0x21);
	send_ctrl_cmd(0xE80A); send_data_cmd(0x01);
	send_ctrl_cmd(0xE80B); send_data_cmd(0x44);
	send_ctrl_cmd(0xE80C); send_data_cmd(0x01);
	send_ctrl_cmd(0xE80D); send_data_cmd(0x62);
	send_ctrl_cmd(0xE80E); send_data_cmd(0x01);
	send_ctrl_cmd(0xE80F); send_data_cmd(0x8D);
	...
	send_ctrl_cmd(0xE90B); send_data_cmd(0x84);
	send_ctrl_cmd(0xE90C); send_data_cmd(0x02);
	send_ctrl_cmd(0xE90D); send_data_cmd(0xB8);
	send_ctrl_cmd(0xE90E); send_data_cmd(0x02);
	send_ctrl_cmd(0xE90F); send_data_cmd(0xF0);
	...
	send_ctrl_cmd(0xEA0B); send_data_cmd(0xB0);
	send_ctrl_cmd(0xEA0C); send_data_cmd(0x03);
	send_ctrl_cmd(0xEA0D); send_data_cmd(0xC0);
	send_ctrl_cmd(0xEA0E); send_data_cmd(0x03);
	send_ctrl_cmd(0xEA0F); send_data_cmd(0xDF);

	send_ctrl_cmd(0xEB00);send_data_cmd(0x03);
	send_ctrl_cmd(0xEB01);send_data_cmd(0xFD);
	send_ctrl_cmd(0xEB02);send_data_cmd(0x03);
	send_ctrl_cmd(0xEB03);send_data_cmd(0xFF); 
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dpi.vsync_back_porch  = 32;
    params->dpi.vsync_front_porch = 32;
#elif 1
	xx
...
static void lcm_suspend(void)
{
...
#else
	LCD_PRINT("punk,lcm_suspend -1.0\n ");
	send_ctrl_cmd(0xF000); send_data_cmd(0x55);
	send_ctrl_cmd(0xF001); send_data_cmd(0xAA);
	send_ctrl_cmd(0xF002); send_data_cmd(0x52);
	send_ctrl_cmd(0xF003); send_data_cmd(0x08);
	...
	MDELAY(150); 
	//Delayms(150); 
	//Lcd_EnvidOnOff(0);        //If using RGB Interface 
#endif
...
static void lcm_resume(void)
{
	...
	send_ctrl_cmd(0x2900);
	 MDELAY(100);
#elif 1
	//Lcd_EnvidOnOff(1);        //If using RGB Interface 
	//MainLCDInitial();                                     
	LCD_PRINT("punk,lcm_resume -1.0\n ");
	send_ctrl_cmd(0xF000); send_data_cmd(0x55);
	send_ctrl_cmd(0xF001); send_data_cmd(0xAA);
	send_ctrl_cmd(0xF002); send_data_cmd(0x52);
	send_ctrl_cmd(0xF003); send_data_cmd(0x08);
...
static unsigned int lcm_compare_id(void)
{
	...
	if(/*(LCM == id)&&*/ lcm_idpin_value >= 100)/*1.8v,100=1.0v*/
	{
		return 1;
	}
	else
...
LCM_DRIVER ips3p2620_qhd_nt35516_lcm_drv = 
{
