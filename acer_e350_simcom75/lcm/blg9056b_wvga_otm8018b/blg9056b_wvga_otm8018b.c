...
static void init_lcm_registers(void)
{
	...
	set_lcm_register(0xD800,0x70);  //GVDD=4.5V      /73 /74
	set_lcm_register(0xD801,0x6e);	//NGVDD=4.5V     /71 /72  
	...
	set_lcm_register(0xE103,0x0f);
	set_lcm_register(0xE104,0x09);
	set_lcm_register(0xE105,0x1a);
	set_lcm_register(0xE106,0x0b);
	set_lcm_register(0xE107,0x0b);
	set_lcm_register(0xE108,0x01);	
	set_lcm_register(0xE109,0x05);
	set_lcm_register(0xE10A,0x03);
	set_lcm_register(0xE10B,0x08);
	set_lcm_register(0xE10C,0x0e);
	set_lcm_register(0xE10D,0x26);
	set_lcm_register(0xE10E,0x23);
	set_lcm_register(0xE10F,0x18);

	//Negative	
	set_lcm_register(0xE200,0x09);
	set_lcm_register(0xE201,0x0b);	
	set_lcm_register(0xE202,0x11);
	set_lcm_register(0xE203,0x0f);
	set_lcm_register(0xE204,0x09);
	set_lcm_register(0xE205,0x1a);
	set_lcm_register(0xE206,0x0b);
	set_lcm_register(0xE207,0x0b);
	...
	set_lcm_register(0xE20D,0x26);
	set_lcm_register(0xE20E,0x23);
	set_lcm_register(0xE20F,0x18);
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dpi.vsync_back_porch  = 16;
...
LCM_DRIVER blg9056b_wvga_otm8018b_lcm_drv = 
{

	.name			= "blg9056b_wvga_otm8018b",
