...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dpi.hsync_pulse_width = 2; //22
    params->dpi.hsync_back_porch  = 26 ; //12;
    params->dpi.hsync_front_porch = 26 ; //16;
    params->dpi.vsync_pulse_width = 10;
    params->dpi.vsync_back_porch  = 20; //33;
    params->dpi.vsync_front_porch = 20; //12;
...
LCM_DRIVER srl5002h_wvga_otm8009a_lcm_drv = 
{

	.name			= "srl5002h_wvga_otm8009a",
