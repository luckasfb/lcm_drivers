...
extern LCM_DRIVER ili9803_lcm_drv;
extern LCM_DRIVER r61526_lcm_drv;
extern LCM_DRIVER ht_r61509_lcm_drv;
extern LCM_DRIVER hc_hx8352c_lcm_drv;
extern LCM_DRIVER jx_rm68090_lcm_drv;
...
#if defined(HC_HX8352C)
	&hc_hx8352c_lcm_drv,
#endif

#if defined(HT_R61509)
	&ht_r61509_lcm_drv,
#endif

#if defined(JX_RM68090)
	&jx_rm68090_lcm_drv,
#endif
};
